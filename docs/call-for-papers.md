...
All submissions will be reviewed using a single-blind review process. The identity of reviewers will not be revealed to authors, but authors can keep their names on the submitted papers, on figures, bibliography, etc.
